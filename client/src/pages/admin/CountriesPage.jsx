...
function CountriesPage() {
  ...
  // Function to get products by selected country
  ...
  const filteredProducts = selectedCountry ? getProductsByCountry() : [];
          ...
          <div className="lg:col-span-3">
            {selectedCountry ? (
              <>
                ...
                {filteredProducts.length === 0 ? (
                  <div className="bg-yellow-50 p-4 rounded-md text-yellow-700">
                    No products found from this country.
                  </div>
                ) : (
              ...
              <div className="bg-green-50 p-6 rounded-lg text-center">
                <GlobeAltIcon className="h-12 w-12 mx-auto text-green-500 mb-3" />
                <h3 className="text-lg font-medium text-green-900 mb-1">Select a Country</h3>
                <p className="text-green-700">
                  Choose a country from the list to view products from that origin.
                </p>
              </div>
            )}
          </div>
